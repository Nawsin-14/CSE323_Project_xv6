...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 59 03 00 00       	call   39d <mkdir>
  ...
  exit();
  5d:	e8 d3 02 00 00       	call   335 <exit>
    printf(2, "Usage: mkdir files...\n");
  62:	52                   	push   %edx
  63:	52                   	push   %edx
  ...
  6b:	e8 30 04 00 00       	call   4a0 <printf>
    exit();
  70:	e8 c0 02 00 00       	call   335 <exit>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb db 07 00 00       	mov    $0x7db,%ebx
 ...
 631:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 24 0b 00 00       	mov    %eax,0xb24
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 24 0b 00 00       	mov    %eax,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 24 0b 00 00    	mov    0xb24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 24 0b 00 00    	cmp    0xb24,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 24 0b 00 00 28 	movl   $0xb28,0xb24
 777:	0b 00 00 
    base.s.size = 0;
 77a:	b8 28 0b 00 00       	mov    $0xb28,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 28 0b 00 00 28 	movl   $0xb28,0xb28
 786:	0b 00 00 
    base.s.size = 0;
 789:	c7 05 2c 0b 00 00 00 	movl   $0x0,0xb2c
 790:	00 00 00 
    if(p->s.size >= nunits){
