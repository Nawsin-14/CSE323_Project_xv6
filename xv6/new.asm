  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if (argc < 2)
  1a:	0f 8f a5 00 00 00    	jg     c5 <main+0xc5>
{
  ...
  30:	74 57                	je     89 <main+0x89>
    { //parent
      printf(1, "Parent %d creating child  %d\n", getpid(), id);
  32:	e8 ee 03 00 00       	call   425 <getpid>
  37:	57                   	push   %edi
  38:	50                   	push   %eax
  39:	68 2c 08 00 00       	push   $0x82c
  3e:	6a 01                	push   $0x1
  40:	e8 cb 04 00 00       	call   510 <printf>
      wait();
  45:	e8 63 03 00 00       	call   3ad <wait>
  ...
  54:	0f 94 c0             	sete   %al
  57:	c1 e0 1f             	shl    $0x1f,%eax
  5a:	c1 f8 1f             	sar    $0x1f,%eax
  5d:	83 c0 02             	add    $0x2,%eax
  for (k = 0; k <= n - 1;)
  60:	39 f0                	cmp    %esi,%eax
  62:	7d 5c                	jge    c0 <main+0xc0>
    id = fork();
  64:	e8 34 03 00 00       	call   39d <fork>
  69:	89 c7                	mov    %eax,%edi
    if (id < 0)
  6b:	85 c0                	test   %eax,%eax
  6d:	79 c1                	jns    30 <main+0x30>
      printf(1, "%d failed in fork!\n", getpid());
  6f:	e8 b1 03 00 00       	call   425 <getpid>
  74:	83 ec 04             	sub    $0x4,%esp
  77:	50                   	push   %eax
  78:	68 18 08 00 00       	push   $0x818
  7d:	6a 01                	push   $0x1
  7f:	e8 8c 04 00 00       	call   510 <printf>
  84:	83 c4 10             	add    $0x10,%esp
  87:	eb c4                	jmp    4d <main+0x4d>
      printf(1, "Child %d created\n", getpid());
  89:	e8 97 03 00 00       	call   425 <getpid>
  8e:	52                   	push   %edx
  8f:	50                   	push   %eax
  90:	68 4a 08 00 00       	push   $0x84a
  95:	6a 01                	push   $0x1
  97:	e8 74 04 00 00       	call   510 <printf>
  9c:	83 c4 10             	add    $0x10,%esp
      for (z = 0; z < 8000000.0; z += 0.02)
  9f:	d9 ee                	fldz
  a1:	dd 05 68 08 00 00    	fldl   0x868
  a7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  ae:	00 
  af:	90                   	nop
  b0:	dc c1                	fadd   %st,%st(1)
  b2:	d9 05 70 08 00 00    	flds   0x870
  b8:	df f2                	fcomip %st(2),%st
  ba:	77 f4                	ja     b0 <main+0xb0>
  bc:	dd d8                	fstp   %st(0)
  be:	dd d8                	fstp   %st(0)
      exit();
  c0:	e8 e0 02 00 00       	call   3a5 <exit>
    n = atoi(argv[1]); //from command line
  c5:	83 ec 0c             	sub    $0xc,%esp
  c8:	ff 70 04             	push   0x4(%eax)
    n = 2;
  cb:	be 02 00 00 00       	mov    $0x2,%esi
    n = atoi(argv[1]); //from command line
  d0:	e8 eb 01 00 00       	call   2c0 <atoi>
  if (n < !20 || n > !0)
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	83 f8 01             	cmp    $0x1,%eax
  db:	0f 87 44 ff ff ff    	ja     25 <main+0x25>
  for (k = 0; k <= n - 1;)
  e1:	0f 84 39 ff ff ff    	je     20 <main+0x20>
  e7:	eb d7                	jmp    c0 <main+0xc0>
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 cc 08 00 00 	movzbl 0x8cc(%edx),%edx
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 584:	ff 24 85 74 08 00 00 	jmp    *0x874(,%eax,4)
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 5c 08 00 00       	mov    $0x85c,%ebx
 ...
 6a1:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 b0 0b 00 00       	mov    %eax,0xbb0
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 b0 0b 00 00       	mov    %eax,0xbb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 b0 0b 00 00    	cmp    0xbb0,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 b4 0b 00 00       	mov    $0xbb4,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 7f6:	0b 00 00 
    base.s.size = 0;
 7f9:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 800:	00 00 00 
    if(p->s.size >= nunits){
