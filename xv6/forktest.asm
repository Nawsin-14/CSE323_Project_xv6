...
main(void)
{
  ...
  exit();
   b:	e8 c5 03 00 00       	call   3d5 <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 c8 03 00 00       	call   3f5 <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 98 04 00 00       	push   $0x498
  4e:	e8 5d 01 00 00       	call   1b0 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 98 04 00 00       	push   $0x498
  5c:	6a 01                	push   $0x1
  5e:	e8 92 03 00 00       	call   3f5 <write>
  ...
  7b:	0f 84 83 00 00 00    	je     104 <forktest+0xc4>
    pid = fork();
  81:	e8 47 03 00 00       	call   3cd <fork>
    if(pid < 0)
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 48 03 00 00       	call   3dd <wait>
  ...
  if(wait() != -1){
  9e:	e8 3a 03 00 00       	call   3dd <wait>
  a3:	83 f8 ff             	cmp    $0xffffffff,%eax
  a6:	75 49                	jne    f1 <forktest+0xb1>
  write(fd, s, strlen(s));
  a8:	83 ec 0c             	sub    $0xc,%esp
  ab:	68 ca 04 00 00       	push   $0x4ca
  b0:	e8 fb 00 00 00       	call   1b0 <strlen>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	50                   	push   %eax
  b9:	68 ca 04 00 00       	push   $0x4ca
  be:	6a 01                	push   $0x1
  c0:	e8 30 03 00 00       	call   3f5 <write>
}
  c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  c8:	c9                   	leave
  c9:	c3                   	ret
      exit();
  ca:	e8 06 03 00 00       	call   3d5 <exit>
  write(fd, s, strlen(s));
  cf:	83 ec 0c             	sub    $0xc,%esp
  d2:	68 a3 04 00 00       	push   $0x4a3
  d7:	e8 d4 00 00 00       	call   1b0 <strlen>
  dc:	83 c4 0c             	add    $0xc,%esp
  df:	50                   	push   %eax
  e0:	68 a3 04 00 00       	push   $0x4a3
  e5:	6a 01                	push   $0x1
  e7:	e8 09 03 00 00       	call   3f5 <write>
      exit();
  ec:	e8 e4 02 00 00       	call   3d5 <exit>
    printf(1, "wait got too many\n");
  f1:	52                   	push   %edx
  f2:	52                   	push   %edx
  f3:	68 b7 04 00 00       	push   $0x4b7
  f8:	6a 01                	push   $0x1
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 d1 02 00 00       	call   3d5 <exit>
    printf(1, "fork claimed to work N times!\n", N);
 104:	50                   	push   %eax
 105:	68 e8 03 00 00       	push   $0x3e8
 10a:	68 d8 04 00 00       	push   $0x4d8
 10f:	6a 01                	push   $0x1
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 ba 02 00 00       	call   3d5 <exit>
