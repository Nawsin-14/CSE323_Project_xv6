...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 41 03 00 00       	call   385 <unlink>
 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 dc 07 00 00 	jmp    *0x7dc(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb d5 07 00 00       	mov    $0x7d5,%ebx
