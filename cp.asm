  ...
  14:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  25:	e8 e6 04 00 00       	call   510 <printf>
    exit();
  2a:	e8 76 03 00 00       	call   3a5 <exit>
  }
  ...
  36:	e8 aa 03 00 00       	call   3e5 <open>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	89 c6                	mov    %eax,%esi
  40:	85 c0                	test   %eax,%eax
  42:	78 69                	js     ad <main+0xad>
  ...
  44:	50                   	push   %eax
  45:	50                   	push   %eax
  46:	68 01 02 00 00       	push   $0x201
  4b:	ff 73 08             	push   0x8(%ebx)
  4e:	e8 92 03 00 00       	call   3e5 <open>
  53:	83 c4 10             	add    $0x10,%esp
  56:	89 c7                	mov    %eax,%edi
  58:	85 c0                	test   %eax,%eax
  5a:	78 34                	js     90 <main+0x90>
    printf(2, "_cp: cannot open %s\n", argv[2]);
    close(srcfd);
    exit();
  }
  ...
  5e:	50                   	push   %eax
  5f:	56                   	push   %esi
  60:	e8 cb 02 00 00       	call   330 <copyfd>
  65:	83 c4 10             	add    $0x10,%esp
  68:	85 c0                	test   %eax,%eax
  6a:	78 56                	js     c2 <main+0xc2>
    close(srcfd);
    close(dstfd);
    exit();
  }
  ...
  6f:	56                   	push   %esi
  70:	e8 58 03 00 00       	call   3cd <close>
  close(dstfd);
  75:	89 3c 24             	mov    %edi,(%esp)
  78:	e8 50 03 00 00       	call   3cd <close>

  // Print only on successful copy
  printf(1, "cp successful\n");
  7d:	58                   	pop    %eax
  7e:	5a                   	pop    %edx
  7f:	68 56 08 00 00       	push   $0x856
  84:	6a 01                	push   $0x1
  86:	e8 85 04 00 00       	call   510 <printf>

  exit();
  8b:	e8 15 03 00 00       	call   3a5 <exit>
    printf(2, "_cp: cannot open %s\n", argv[2]);
  90:	57                   	push   %edi
  91:	ff 73 08             	push   0x8(%ebx)
  94:	68 30 08 00 00       	push   $0x830
  99:	6a 02                	push   $0x2
  9b:	e8 70 04 00 00       	call   510 <printf>
    close(srcfd);
  a0:	89 34 24             	mov    %esi,(%esp)
  a3:	e8 25 03 00 00       	call   3cd <close>
    exit();
  a8:	e8 f8 02 00 00       	call   3a5 <exit>
    printf(2, "_cp: cannot open %s\n", argv[1]);
  ad:	50                   	push   %eax
  ae:	ff 73 04             	push   0x4(%ebx)
  b1:	68 30 08 00 00       	push   $0x830
  b6:	6a 02                	push   $0x2
  b8:	e8 53 04 00 00       	call   510 <printf>
    exit();
  bd:	e8 e3 02 00 00       	call   3a5 <exit>
    printf(2, "_cp: copy error\n");
  c2:	51                   	push   %ecx
  c3:	51                   	push   %ecx
  c4:	68 45 08 00 00       	push   $0x845
  c9:	6a 02                	push   $0x2
  cb:	e8 40 04 00 00       	call   510 <printf>
    close(srcfd);
  d0:	89 34 24             	mov    %esi,(%esp)
  d3:	e8 f5 02 00 00       	call   3cd <close>
    close(dstfd);
  d8:	89 3c 24             	mov    %edi,(%esp)
  db:	e8 ed 02 00 00       	call   3cd <close>
    exit();
  e0:	e8 c0 02 00 00       	call   3a5 <exit>
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 65 08 00 00       	mov    $0x865,%ebx
 ...
 6a1:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 77b:	3b 05 a8 0b 00 00    	cmp    0xba8,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 7df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 ac 0b 00 00       	mov    $0xbac,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 7f6:	0b 00 00 
    base.s.size = 0;
 7f9:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 800:	00 00 00 
    if(p->s.size >= nunits){
