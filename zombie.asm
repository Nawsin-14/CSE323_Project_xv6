...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 c7 02 00 00       	call   2dd <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 51 03 00 00       	call   375 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 b9 02 00 00       	call   2e5 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4c4:	ff 24 85 60 07 00 00 	jmp    *0x760(,%eax,4)
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 58 07 00 00       	mov    $0x758,%ebx
