...
main(int argc, char **argv)
{
  ...
  39:	e8 07 03 00 00       	call   345 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 cb 02 00 00       	call   315 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 28 04 00 00       	call   480 <printf>
    exit();
  58:	e8 b8 02 00 00       	call   315 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 41b:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f4:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb 9c 07 00 00       	mov    $0x79c,%ebx
 ...
 611:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 e4 0a 00 00       	mov    %eax,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 e4 0a 00 00    	cmp    0xae4,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 766:	0a 00 00 
    base.s.size = 0;
 769:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 770:	00 00 00 
    if(p->s.size >= nunits){
